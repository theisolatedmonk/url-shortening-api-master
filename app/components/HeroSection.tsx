...
export default function HeroSection({ }: Props) {
    return (
        <div className='flex sm:flex-row-reverse flex-col items-center justify-between gap-10 overflow-hidden pb-10 pt-5  sm:pl-16'>
            <div className="flex w-[120%] sm:w-[80%] h-full">
                <Image src={illustrationWorking} alt={''} width={600} height={600} className=' ml-20 w-full xl:ml-36' />
            </div>
            <div className="flex flex-col items-center gap-5 sm:pl-6 sm:items-start">
                ...
                <button className='rounded-full bg-Cyan hover:bg-opacity-80 bg-opacity-100 p-4 px-6 w-40 text-white'>Get Started
                </button>
            </div>
